...
- Good knowledge of containers, kubernetes and CoreOS is important. You will also be expected to have strong knowledge of Networking, Security, Linux (Kernel, Namespaces, cgroups). Finally, backend skills in at least one language and caring about best development practices, are required.
